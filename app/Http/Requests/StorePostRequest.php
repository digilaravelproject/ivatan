...
class StorePostRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        switch ($type) {
            ...
            case 'video':
                // ✅ Video Requirement: Title aur Caption dono chahiye
                $rules['title'] = 'required|string|max:150'; // Title required
                $rules['caption'] = 'required|string|max:2200'; // Description (caption) required
    ...
    {
        return [
            'title.required' => 'A title is required for videos.',
            'caption.required' => 'A description is required for videos.',
