...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\Digi Laravel Prrojects\ivatan\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\Digi Laravel Prrojects\\ivatan\\public\\storage',
'laravel-ffmpeg.ffmpeg.binaries','laravel-ffmpeg.ffmpeg.threads','laravel-ffmpeg.ffprobe.binaries','laravel-ffmpeg.timeout','laravel-ffmpeg.log_channel',
'laravel-ffmpeg.temporary_files_root','laravel-ffmpeg.temporary_files_encrypted_hls','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'session.same_site','session.partitioned','chunk-upload.storage.chunks','chunk-upload.storage.disk','chunk-upload.clear.timestamp',
'chunk-upload.clear.schedule.enabled','chunk-upload.clear.schedule.cron','chunk-upload.chunk.name.use.session','chunk-upload.chunk.name.use.browser','chunk-upload.handlers.custom',
'chunk-upload.handlers.override','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'profile.edit','profile.update','profile.destroy','admin.dashboard','admin.dashboard.summary',
'admin.dashboard.chart','admin.dashboard.activityfeed','admin.profile.edit','admin.profile.update','admin.users.index',
'admin.users.show','admin.users.block','admin.users.unblock','admin.users.verify','admin.users.destroy','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','storage.local',);
        registerArgumentsSet('views', 
'admin.dashboard','admin.layouts.app','admin.profile.edit','admin.users.index','auth.confirm-password',
'auth.forgot-password','auth.login','auth.register','auth.reset-password','auth.verify-email',
'components.admin.app-layout','components.admin.module.recent-activity','components.admin.sidebar','components.admin.topbar','components.application-logo',
...
'layouts.navigation','media-library::image','media-library::placeholderSvg','media-library::responsiveImage','media-library::responsiveImageWithPlaceholder',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','vendor.media-library.image',
'vendor.media-library.placeholderSvg','vendor.media-library.responsiveImage','vendor.media-library.responsiveImageWithPlaceholder','welcome','laravel-exceptions-renderer::components.card',
...
'MAIL_PASSWORD','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','FILESYSTEM_DISK','AWS_ACCESS_KEY_ID',
