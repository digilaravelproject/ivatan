...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\Digi_Laravel_Prrojects\ivatan\public\storage' => 'string',
            ...
            'laravel-ffmpeg.ffmpeg.binaries' => 'string',
            'laravel-ffmpeg.ffmpeg.threads' => 'integer',
            'laravel-ffmpeg.ffprobe.binaries' => 'string',
            'laravel-ffmpeg.timeout' => 'integer',
            'laravel-ffmpeg.log_channel' => 'string',
            'laravel-ffmpeg.temporary_files_root' => 'string',
            'laravel-ffmpeg.temporary_files_encrypted_hls' => 'string',
...
'admin-actions','view','delete','update','viewAny',
'create','restore','forceDelete','before','__construct',
'addParticipant','leaveGroup','removeParticipant','denyWithStatus','denyAsNotFound',);
...
'cache.stores.dynamodb.endpoint','cache.stores.octane.driver','cache.prefix','chunk-upload.storage.chunks','chunk-upload.storage.disk',
'chunk-upload.clear.timestamp','chunk-upload.clear.schedule.enabled','chunk-upload.clear.schedule.cron','chunk-upload.chunk.name.use.session','chunk-upload.chunk.name.use.browser',
'chunk-upload.handlers.custom','chunk-upload.handlers.override','database.default','database.connections.sqlite.driver','database.connections.sqlite.url',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\Digi_Laravel_Prrojects\\ivatan\\public\\storage','ide-helper.filename',
...
'ide-helper.additional_relation_types','ide-helper.additional_relation_return_types','ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Jpegoptim',
'image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Pngquant','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Optipng','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Svgo','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Gifsicle','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Cwebp',
'image-optimizer.binary_path','image-optimizer.timeout','image-optimizer.log_optimizer_activity','laravel-ffmpeg.ffmpeg.binaries','laravel-ffmpeg.ffmpeg.threads',
'laravel-ffmpeg.ffprobe.binaries','laravel-ffmpeg.timeout','laravel-ffmpeg.log_channel','laravel-ffmpeg.temporary_files_root','laravel-ffmpeg.temporary_files_encrypted_hls',
...
'services.ses.secret','services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.razorpay.key',
'services.razorpay.secret','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'session.same_site','session.partitioned','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'profile.update','profile.destroy','admin.dashboard.index','admin.dashboard.summary','admin.dashboard.chart',
'admin.dashboard.activityfeed','admin.profile.edit','admin.profile.update','admin.users.index','admin.users.trashed',
'admin.users.show','admin.users.block','admin.users.unblock','admin.users.verify','admin.users.unverify',
'admin.users.seller.toggle','admin.users.employer.toggle','admin.users.destroy','admin.users.restore','admin.users.delete',
'admin.user.follower','admin.user.following','admin.userpost.update','admin.userpost.details','admin.userpost.index',
'admin.userpost.likes','admin.userpost.comments','admin.userpost.comments.delete','admin.userpost.softDelete','admin.products.index',
'admin.products.show','admin.products.approve','admin.products.reject','admin.products.bulk.approve','admin.products.bulk.reject',
'admin.services.index','admin.services.show','admin.services.approve','admin.services.reject','admin.services.bulk.approve',
'admin.services.bulk.reject','admin.jobs.index','admin.jobs.show','admin.jobs.edit','admin.jobs.update',
'admin.jobs.destroy','admin.jobs.applications','admin.applications.resume','admin.orders.index','admin.orders.updateStatus',
'admin.ads.index','admin.ads.show','admin.ads.pending','admin.ads.approve','admin.ads.reject',
'admin.ad.ad-packages.index','admin.ad.ad-packages.create','admin.ad.ad-packages.store','admin.ad.ad-packages.show','admin.ad.ad-packages.edit',
'admin.ad.ad-packages.update','admin.ad.ad-packages.destroy','register','login','password.request','password.email',
...
'admin.ads.index','admin.ads.packages.create','admin.ads.packages.edit','admin.ads.packages.index','admin.ads.packages.show',
'admin.ads.pending','admin.ads.show','admin.dashboard.index','admin.jobs.applications','admin.jobs.edit',
'admin.jobs.index','admin.jobs.show','admin.layouts.app','admin.orders.index','admin.post.comments',
'admin.post.details','admin.post.index','admin.post.likes','admin.post.partials.comment','admin.product.index',
'admin.product.show','admin.profile.edit','admin.service.index','admin.service.show','admin.users.index',
'admin.users.show','admin.users.trashed','auth.confirm-password','auth.forgot-password','auth.login',
'auth.register','auth.reset-password','auth.verify-email','components.admin.app-layout','components.admin.media-render',
'components.admin.module.recent-activity','components.admin.sidebar','components.admin.topbar','components.application-logo','components.auth-session-status',
...
'components.text-input','dashboard','errors.401','errors.402','errors.403',
'errors.404','errors.419','errors.429','errors.500','errors.503',
'errors.layout','errors.minimal','layouts.app','layouts.guest','layouts.navigation',
...
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','vendor.mail.html.button','vendor.mail.html.footer',
...
'vendor.mail.text.message','vendor.mail.text.panel','vendor.mail.text.subcopy','vendor.mail.text.table','vendor.media-library.image',
'vendor.media-library.placeholderSvg','vendor.media-library.responsiveImage','vendor.media-library.responsiveImageWithPlaceholder','vendor.notifications.email','vendor.pagination.bootstrap-4',
...
'vendor.pagination.simple-default','vendor.pagination.simple-tailwind','vendor.pagination.tailwind','welcome','laravel-exceptions-renderer::components.badge',
...
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.xampp.htdocs.Digi_Laravel_Prrojects.ivatan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','PHP_CLI_SERVER_WORKERS',
'BCRYPT_ROUNDS','LOG_CHANNEL','LOG_STACK','LOG_LEVEL','LOG_DEPRECATIONS_CHANNEL',
'DB_CONNECTION','DB_HOST','DB_PORT','DB_DATABASE','DB_USERNAME',
'DB_PASSWORD','CACHE_DRIVER','CACHE_STORE','SESSION_DRIVER','SESSION_LIFETIME',
'SESSION_ENCRYPT','SESSION_PATH','SESSION_DOMAIN','QUEUE_CONNECTION','SCOUT_DRIVER',
'BROADCAST_CONNECTION','BROADCAST_DRIVER','REVERB_APP_ID','REVERB_APP_KEY','REVERB_APP_SECRET',
'REVERB_HOST','REVERB_PORT','REVERB_SCHEME','VITE_REVERB_APP_KEY','VITE_REVERB_HOST',
'VITE_REVERB_PORT','VITE_REVERB_SCHEME','MAIL_MAILER','MAIL_SCHEME','MAIL_HOST',
'MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD','MAIL_FROM_ADDRESS','MAIL_FROM_NAME',
'REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','MEMCACHED_HOST',
'FILESYSTEM_DISK','MEDIA_DISK','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION',
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','RAZORPAY_KEY','RAZORPAY_SECRET',);
