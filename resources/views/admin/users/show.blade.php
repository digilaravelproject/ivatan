                    ...
                    <div class="border rounded-lg overflow-hidden shadow-sm">
                        ...
                        <div class="p-4 flex justify-between items-center text-sm text-gray-600">
                            <div class="flex items-center space-x-2">
                                <a href="{{ route('admin.post.likes', $post->id) }}" aria-label="Like this post"
                                    class="text-sm text-blue-500 hover:text-blue-700 flex items-center transition-all duration-200 ease-in-out">
                             ...
                             <div class="flex items-center space-x-2">
                                <a href="{{ route('admin.post.comments', $post->id) }}" aria-label="Like this post"
                                    class="text-sm text-blue-500 hover:text-blue-700 flex items-center transition-all duration-200 ease-in-out">
                                    <i class="fas fa-comment-dots mr-1"></i> <!-- Comment icon -->
