            ...
            <div class="row align-items-center">
                <div class="col-lg-8 mx-auto text-center">
                    <div class="hero-content fade-up">
                        ...
                        <p>Please read these terms carefully before using i-Vatan. Your use of the platform constitutes
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="terms-section fade-up" id="introduction">
                        ...
                        <p>Welcome to <strong>i-Vatan (iApp)</strong>, a social media + digital service platform
                            operated by <strong>Octroid Pvt. Ltd.</strong>, registered in India under applicable laws.
                            These Terms and Conditions ("T&C") govern your use of the i-Vatan application ("iApp"),
                            website, and all associated services.</p>
                        ...
                        <div class="highlight-box">
                            ...
                            <p>i-Vatan (iApp) is an intermediary service provider that facilitates content sharing, job
                                discovery, marketplace access, user communication, and creator monetization. We do not
                                hold any liability or responsibility for user-generated actions or content and operate
                                solely as a bridge between users and their interactive digital environment.</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section fade-up delay-1" id="in-app-use">
                        ...
                        <p>User activity is monitored only for the purpose of enhancing app performance, detecting
                            spam/fraud, and recommending personalized content.</p>

                        <p>The collected data will be stored within Indian jurisdiction and used only when both user and
                            company gain value from it (example: ads, job alerts).</p>

                        <div class="highlight-box">
                            <h5><i class="fas fa-exclamation-triangle"></i> Prohibited Activities</h5>
                            <p>No part of i-Vatan is to be used to promote or perform illegal, harmful, or unauthorized
                                activities. Breach will result in permanent suspension and legal liability under IT Act,
                                2000.</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section fade-up delay-1" id="trust-ecosystem">
                        ...
                        <p>i-Vatan is built on trust, accountability, and ethical interaction. Any user involved in
                            fraud, impersonation, harassment, or fake content shall be penalized under relevant sections
                            of the IT Act, 2000 and Indian Penal Code.</p>
                        ...
                        <p>Any attempts to manipulate trust - such as misleading claims, fake jobs/products, or abuse of
                            features, shall result in:</p>
                        <ul>
                    ...
                    <div class="terms-section fade-up" id="data-usability">
                        ...
                        <p>Downloading, duplicating, or exporting user data from i-Vatan for external platform use
                            without written consent of the company is prohibited and punishable under Indian law.</p>

                        <p>i-Vatan reserves the right to collect anonymized trend data for research and development.</p>

                        <p><strong>Warning:</strong> Any misuse of stored user data will lead to permanent ban, FIR
                            registration, and potential legal action.</p>
                    </div>
                    ...
                    <div class="terms-section fade-up delay-1" id="connectivity">
                        ...
                        <p>Users are permitted to connect with others within the i-Vatan ecosystem, either with context
                            (mutual interest, posts, jobs, marketplace) or without it.</p>
                        ...
                        <p>Connections may occur with or without prior context, but users are expected to behave
                            responsibly.</p>

                        <h3>Prohibited Behavior</h3>
                        <p>Any misuse of this feature, including harassment, abuse, spam, unsolicited promotional
                            messages, or harmful behavior, will result in:</p>
                        <ul>
                        ...
                        <div class="highlight-box">
                            ...
                            <p>All users are expected to maintain a civil, respectful, and disciplined tone while
                                engaging with others, as per community guidelines and Indian cyber laws. Users must
                                represent a respectful environment on i-Vatan.</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section fade-up" id="privacy-control">
                        ...
                        <div class="highlight-box">
                            ...
                            <p>Consent mechanisms are clearly displayed for every data-sharing instance, and no hidden
                                tracking occurs. All collected data is encrypted, stored securely, and accessible only
                                with user permission.</p>
                        </div>

                        <p>Trust and understanding are expected between platform and user. Misrepresentation or breach
                            of mutual consent is punishable as per IT Act and platform policies.</p>
                    </div>
                    ...
                    <div class="terms-section fade-up delay-1" id="vulnerability">
                        ...
                        <ul>
                            <li>We employ encryption, internal audits, firewall protections, and secure login mechanisms
                            </li>
                            <li>Third-party integrations (e.g., payment, delivery) follow strict security compliance
                            </li>
                            <li>Users are prohibited from sharing app content, screenshots, or internal data on external
                                channels for malicious intent</li>
                        </ul>

                        <h3>User Responsibility</h3>
                        <p>Users are advised not to share sensitive information (e.g., OTPs, payment details) via chats
                            or comments.</p>

                        <p>Users are encouraged to report suspicious activity and use multi-step verification wherever
                            possible.</p>
                        ...
                        <p><strong>Warning:</strong> Any attempt to tamper with system data or export information to
                            other platforms will be tracked and legally pursued.</p>
                    </div>
                    ...
                    <div class="terms-section fade-up" id="legal-framework">
                        ...
                        <p>Users agree to indemnify and hold Octroid Pvt. Ltd. harmless from any disputes, claims, or
                            legal proceedings arising from their activities on the platform.</p>

                        <div class="highlight-box">
                            <h5><i class="fas fa-map-marker-alt"></i> Jurisdiction</h5>
                            <p>Jurisdiction for all matters shall rest solely with the courts located in Mumbai, Nashik,
                                Maharashtra, INDIA. This may change according to requirement and INDIAN LAW.</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section fade-up delay-1" id="acceptance">
                        ...
                        <p>By creating an account or continuing to use the i-Vatan (iApp) platform, users acknowledge
                            that they have:</p>
                        <ul>
                        ...
                        <div class="highlight-box">
                            ...
                            <p>By ticking the box during signup/login, I confirm that I have read and accept the i-Vatan
                                (iApp) Terms and Conditions, Privacy Policy, and agree to comply with all applicable
                                laws and platform rules.</p>
                        </div>

                        <h3>Consequences of Non-Compliance</h3>
                        <p>Failure to adhere to any clause may result in partial or complete termination of account
                            privileges without prior notice.</p>

                        <h3>Policy Updates</h3>
                        <p>i-Vatan and Octroid Pvt. Ltd. reserve the right to update, amend, or change these terms at
                            any time, with or without user notice. All users are advised to revisit the terms
                            periodically.</p>
                        ...
                        <div
                            ...
                            <p style="color: white; margin: 0; font-size: 1.1rem;">To i-Vatan app by OCTROID PVT. LTD.
                            </p>
