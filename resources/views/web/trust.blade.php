            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="terms-section fade-up" id="what-is">
                        ...
                        <p><strong>i-Trust</strong> is the in-app TrustScore system inside <strong>i-Vatan (iApp)</strong>. It measures and displays a user's credibility, reliability, and authenticity across all platform activities. It's an <strong>AUTO-INDEPENDENT system</strong> that works on review and environment inputs, including social, jobs, marketplace, and creator tools.</p>

                        <p>It works like a digital trust identity, empowering users and creating a transparent, fraud-free environment.</p>

                        <div class="highlight-box">
                            <h5><i class="fas fa-info-circle"></i> Key Features</h5>
                            <p>i-Trust continuously monitors and evaluates user behavior, transactions, and community interactions to provide a real-time trust rating that helps create a safer digital ecosystem.</p>
                        </div>
                    </div>
                        ...
                        <div class="workflow-steps">
                            <div class="workflow-step">
                                ...
                                <div class="step-content">
                                    ...
                                    <p>User registers and verifies their identity (mobile + optional KYC/DigiLocker).</p>
                                </div>
                            </div>
                            ...
                            <div class="workflow-step">
                                ...
                                <div class="step-content">
                                    ...
                                    <p>Scores below the threshold may lead to restricted access, penalties, or suspension.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="terms-section fade-up" id="terms">
                        ...
                        <ul>
                            ...
                            <li>Octroid Pvt. Ltd. does not guarantee employment, sales, or outcomes based solely on TrustScore. It's an <strong>AUTO-INDEPENDENT system</strong> that works on review and environment inputs.</li>
                        </ul>
                        ...
                        <ul>
                            <li>TrustScore can be viewed by other users (Environment Members, employers, buyers, creators, business, etc.) as an indicator of credibility.</li>
                    ...
                    <div class="terms-section fade-up delay-1" id="privacy">
                        ...
                        <p>Raw activity data remains private. Only final TrustScore and badges are visible to others.</p>
                        ...
                        <p>Complies with Indian IT Act 2000, Consumer Protection Rules 2020, and DPDP Bill 2023 readiness.</p>

                        <div class="highlight-box">
                            <h5><i class="fas fa-eye-slash"></i> Hide TrustScore Option</h5>
                            <p>All users can request to hide their TrustScore from their profile by contacting the platform team with a strong reason.</p>
                        </div>
                    </div>
                    ...
                    <div class="terms-section fade-up delay-1" id="indemnity">
                        ...
                        <div class="highlight-box">
                            ...
                            <ul style="margin-left: 0; padding-left: 1.5rem; margin-top: 0.5rem;">
                                <li>Octroid Pvt. Ltd. is not liable for damages, losses, or disputes arising from reliance on TrustScore.</li>
                                <li>All users indemnify Octroid against claims arising from misuse, fraud, or misrepresentation of their TrustScore.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="terms-section fade-up" id="acceptance">
                        ...
                        <ul>
                            ...
                            <li>You accept that Octroid Pvt. Ltd. has the final authority on TrustScore assignment, revision, and suspension.</li>
                        </ul>
                        ...
                        <div style="text-align: center; margin-top: 3rem; padding: 2.5rem; background: linear-gradient(135deg, var(--primary-color) 0%, var(--secondary-color) 100%); border-radius: 20px; color: white;">
                            ...
                            <p style="color: white; margin-top: 1.5rem; font-size: 1.3rem; font-weight: 600;">Your Digital Identity Matters!</p>
                        </div>
                    </div>
                </div>
            </div>
