            ...
            <div class="row align-items-center">
                <div class="col-lg-8 mx-auto text-center">
                    <div class="hero-content fade-up">
                        ...
                        <p>Your privacy is important to us. Learn how i-Vatan protects your data and respects your rights.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="policy-section fade-up" id="ownership">
                        ...
                        <p>All content (text, images, videos, products, job postings, etc.) uploaded, created, or shared on i-Vatan ("Platform") by any user (including individual users, creators, marketplace vendors, organizations, and corporate profiles) remains the intellectual property of its original creator or owner.</p>

                        <h3>User Restrictions</h3>
                        <p>Users are strictly prohibited from:</p>
                        <ul>
                            <li>Copying, reproducing, or distributing any data or content from i-Vatan on external platforms or services without explicit written consent from the content owner and/or Octroid Pvt. Ltd.</li>
                        ...
                        <div class="highlight-box">
                            ...
                            <p>Any violation of this clause will result in immediate account suspension, legal consequences, and forfeiture of rights to access or earnings from the platform.</p>
                        </div>
                    </div>
                    ...
                    <div class="policy-section fade-up delay-1" id="revenue">
                        ...
                        <p>If i-Vatan data or user-generated content is used or monetized (directly or indirectly) on any other platform also on i-Vatan platform, the revenue generated must be shared fairly with the original content owner(s) as per mutual agreement or as directed by Octroid Pvt. Ltd.</p>

                        <h3>Attribution Requirements</h3>
                        <p>When sharing, referencing, or republishing i-Vatan content outside the Platform, proper attribution to both the original creator and i-Vatan is strictly mandatory.</p>

                        <p><strong>Consequences of Non-Compliance:</strong> Failure to comply will lead to removal of the content, account penalties, legal proceedings, and recovery of damages as per Indian IPR and IT laws.</p>
                    </div>
                    ...
                    <div class="policy-section fade-up" id="profile">
                        ...
                        <p>Your profile data (including personal details, preferences, tags, and connected accounts) are collected and processed with your explicit consent, granted during registration or through subsequent profile updates.</p>

                        <h3>How We Use Your Profile Data</h3>
                        <p>This data is utilized strictly for:</p>
                        <ul>
                            <li>Platform functionality and secure identity verification (including Digilocker API integration)</li>
                        ...
                        <div class="highlight-box">
                            ...
                            <p>We only collect data that's necessary to provide you with a secure and personalized experience on i-Vatan.</p>
                        </div>
                    </div>
                    ...
                    <div class="policy-section fade-up delay-1" id="data">
                        ...
                        <ul>
                            ...
                            <li><strong>Platform activity data:</strong> e.g., browsing behavior, likes, shares, purchases, search history</li>
                        </ul>
                        ...
                        <div class="highlight-box">
                            ...
                            <p>Your data will never be sold or shared with unauthorized third parties. Access to data is provided only:</p>
                    ...
                    <div class="policy-section fade-up" id="security">
                        ...
                        <h3>Core Features</h3>
                        <p>Our core features are built to enhance user experience while preserving user rights. These include:</p>
                        <ul>
                        ...
                        <p>Usability tracking is implemented to detect bugs, prevent misuse, and make continuous updates without compromising data security or exposing identities.</p>

                        <h3>Activity Tracing and Monitoring</h3>
                        <p>Every interaction on the platform (post, comment, follow, like, application, listing) is logged for internal quality and compliance.</p>
                        ...
                        <p>Such data is only accessible by authorized staff for moderation and not exposed to external parties.</p>

                        <h3>End-to-End Encryption</h3>
                        <div class="highlight-box">
                            <h5><i class="fas fa-lock"></i> Maximum Security</h5>
                            <p>Most of the i-Vatan features are End-To-End encrypted, that not allow outsider as well as i-vatan platform "us" to see, share and track the data.</p>
                            <p style="margin-top: 0.5rem;"><strong>Protected Data:</strong> Messages, transactions, internal activity, performance activity, user inputs</p>
                        </div>

                        <h3>Account Connection and Environment</h3>
                        <p>Users can link their i-Vatan accounts to external services like Digilocker or third-party business tools. Each integration requires the user's permission and follows encrypted connection protocols.</p>

                        <p>We collect limited device/environmental data (browser type, IP, crash logs) to maintain system integrity and troubleshoot technical errors efficiently.</p>
                    </div>
                    ...
                    <div class="policy-section fade-up delay-1" id="messaging">
                        ...
                        <p>All direct messages, shared posts, and internal conversations are governed by our content guidelines. (May be access and need the Legal request under IT act)</p>
                        ...
                        <p>Publicly shared content must follow our attribution rules. Reuse or external sharing without credit is prohibited and liable under intellectual property norms.</p>
                    </div>
                    ...
                    <div class="policy-section fade-up" id="liability">
                        ...
                        <p>Breach of any privacy, content, or attribution rule is subject to investigation, temporary or permanent account restrictions, and possible legal enforcement.</p>

                        <p>Octroid Pvt. Ltd. reserves full right to act on behalf of content creators or platform integrity in all legal forums.</p>

                        <h3>Complaint Resolution</h3>
                        <p>Users can raise complaints or data access requests through our in-app support channel or official email address.</p>
                        ...
                        <div class="highlight-box">
                            ...
                            <p style="margin-top: 0.5rem;">Website: <strong>www.ivatan.in</strong> | <strong>www.octroid.in</strong></p>
                        </div>
                    </div>
                    ...
                    <div class="policy-section fade-up delay-1" id="modifications">
                        ...
                        <p>This privacy policy is subject to periodic updates in line with evolving technology, laws, and platform enhancements.</p>

                        <p>All users will be or may be notified within the app or website prior to significant changes.</p>
                        ...
                        <ul>
                            ...
                            <li>AGREE to share there all "stated rules and points and T&C in doc." and use for the company beneficial and user to maintain the safe and trust environment as per platform motive</li>
                        </ul>
