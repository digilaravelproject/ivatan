...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Feature Sections - Spacing Reduced Here */
        ...
        /* Dark Section - Spacing Reduced Here */
        .dark-section { background: var(--dark-bg); color: white; padding: 50px 0; }
        ...
        /* ========= SLIDER CSS ========= - Spacing Reduced Here */
        .update-section { padding: 50px 0; background: var(--light-bg); overflow: hidden; }
                ...
                <div class="col-lg-10">
                    ...
                    <div class="consent-box fade-up delay-1">
                        ...
                        <div class="text-center">
                            ...
                            <button class="btn btn-download btn-lg px-5 mt-2" 
    onmouseover="this.style.color='#ffffff'" 
    onmouseout="this.style.color=''">
    I Confirm & Enter i-Vatan
</button>
                        </div>
                    </div>
                </div>
